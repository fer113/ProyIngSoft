...
public class MapsFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //LatLng ubic = new LatLng(latitudeGPS, longitudeGPS);
        LatLng ubic = new LatLng(19.504284, -99.146607);
        mMap.addMarker(new MarkerOptions().position(ubic).title("Ubicación"));
        float zoomlevel=16;
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(ubic, zoomlevel));
    }
